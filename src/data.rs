// Mac mappings are from https://github.com/fastfetch-cli/fastfetch/blob/dev/src/detection/host/host_apple.c
pub fn mac_mapping(hw_model: &str) -> &str {
    match hw_model {
        model if model.starts_with("MacBookPro") => match &model["MacBookPro".len()..] {
            "18,3" | "18,4" => "MacBook Pro (14-inch, 2021)",
            "18,1" | "18,2" => "MacBook Pro (16-inch, 2021)",
            "17,1" => "MacBook Pro (13-inch, M1, 2020)",
            "16,4" => "MacBook Pro (16-inch, 2019)",
            "16,3" => "MacBook Pro (13-inch, 2020, Two Thunderbolt 3 ports)",
            "16,2" => "MacBook Pro (13-inch, 2020, Four Thunderbolt 3 ports)",
            "16,1" => "MacBook Pro (16-inch, 2019)",
            ...
            "4,1" => "MacBook Pro (17/15-inch, Early 2008)",
            _ => model,
        },
        model if model.starts_with("MacBookAir") => match &model["MacBookAir".len()..] {
        ...
        model if model.starts_with("Macmini") => match &model["Macmini".len()..] {
        ...
        model if model.starts_with("MacBook") => match &model["MacBook".len()..] {
        ...
        model if model.starts_with("MacPro") => match &model["MacPro".len()..] {
            "7,1" => "Mac Pro (2019)",
        ...
        model if model.starts_with("Mac") => match &model["Mac".len()..] {
        ...
        model if model.starts_with("iMac") => match &model["iMac".len()..] {
